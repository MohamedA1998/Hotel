...
@section('content')
    ...
    <!-- Inner Banner -->
    {{-- <x-inner-banner home="Home" title="Blog Style Two" bg="inner-bg4" /> --}}
        ...
        <div class="container">
            <div class="inner-title">
                <ul>
                    ...
                    <li>{{ $CatId->CategoryName }}</li>
                </ul>
                <h3>{{ $CatId->CategoryName }}</h3>
                {{-- 
                    Get CategoryName By Relashen With blogpost
                    <h3>{{ $blogpost->pluck('blogcat.CategoryName')->first() }}</h3>
                --}}
            </div>
        </div>
    </div>
